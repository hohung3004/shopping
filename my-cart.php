...
// code for Shipping address updation
	if(isset($_POST['shipupdate']))
	{
		...
		if($query)
		{
echo "<script>alert('Địa chỉ vận chuyển đã được cập nhật');</script>";
		}
	}
/**
 *
...
?>
					...
					<td class="cart-product-sub-total"><span class="cart-sub-total-price"><?php echo currency_format($row['productPrice']); ?> </span></td>
<td class="cart-product-sub-total"><span class="cart-sub-total-price"><?php  if( $shippcharge=$row['shippingCharge'] == 0){
			 echo $shippcharge=$row['shippingCharge'];
	 ...
	 ?> </span></td>
					...
					<td class="cart-product-grand-total"><span class="cart-grand-total-price"><?php echo currency_format($_SESSION['cart'][$row['id']]['quantity']*$row['productPrice']+$row['shippingCharge']); ?>  </span></td>
				</tr>
...
<div class="form-group">
						...
						<div class="form-group">
					    <label class="info-title" for="Billing State ">Tỉnh/Thành phố<span>*</span></label>
			 <input type="text" class="form-control unicase-form-control text-input" id="bilingstate" name="bilingstate" value="<?php echo $row['billingState'];?>" required>
					  ...
					  <div class="form-group">
					    <label class="info-title" for="Billing City">Quận/Huyện<span>*</span></label>
 ...
 <div class="form-group">
					    <label class="info-title" for="Billing Pincode">Phường/Xã<span>*</span></label>
		...
		<thead>
			<tr>
				<th>
					...
					<div class="cart-grand-total">Tổng Thanh Toán: <span class="inner-left-md"><?php echo currency_format($_SESSION['tp']="$totalprice"); ?></span>
					</div>
				</th>
			</tr>
		</thead><!-- /thead -->
