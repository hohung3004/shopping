...
$pid=intval($_GET['pid']);
if(isset($_GET['pid']) && $_GET['action']=="Yêu Thích" ){
...
<html lang="vi">
	<head>
        ...
        <!-- Fonts --> 
		<link href="https://fonts.googleapis.com/css?family=Open+Sans:300,300i,400,400i,600,600i,700,700i|Raleway:300,300i,400,400i,500,500i,600,600i,700,700i|Poppins:300,300i,400,400i,500,500i,600,600i,700,700i" rel="stylesheet" rel='stylesheet' type='text/css'>
		<link rel="shortcut icon" href="assets/images/Truesmart.ico">
		<style>
...
?>
			...
			<ul class="list-inline list-unstyled">
				<li><a href="index.php">TRUESMART</a></li>
			 <?php echo htmlentities($rw['catname']);?><span> / </span>
				<?php echo htmlentities($rw['subcatname']);?><span> / </span>
...
<h3 class="section-title" style=' font-weight: bold;'>XEM THÊM</h3>
    ...
    ?>
	    	<div class="accordion-group">
	            <div class="accordion-heading">
	                <a style=' font-weight: bold;' href="category.php?cid=<?php echo $row['id'];?>"  class="accordion-toggle collapsed">
...
<div class="sidebar-widget hot-deals wow fadeInUp">
	<h3 class="section-title"style=' font-weight: bold;'>Ưu đãi</h3>
					...
					<div class="products">
						...
						<div class="product-info text-left m-t-20">
							...
							<div class="product-price">	
								<span class="price">
									<?php  echo currency_format($rws['productPrice']);?>
								</span>
									
							    <span class="price-before-discount"><?php  echo currency_format($row['productPriceBeforeDiscount']);?></span>					
...
?>		
							<div class="rating-reviews m-t-20">
								<div class="row">
									...
									<div class="col-sm-8">
										<div class="reviews">
											<a href="#" class="lnk">(<?php echo htmlentities($num);?> Đánh Gía)</a>
										</div>
									</div>
								</div><!-- /.row -->		
							</div><!-- /.rating-reviews -->
...
<div class="stock-container info-container m-t-10">
								<div class="row">
									<div class="col-sm-3">
										<div class="stock-box">
											<span class="label">SẢN XUẤT :</span>
										</div>	
									</div>
									<div class="col-sm-9">
										<div class="stock-box">
...
<div class="stock-container info-container m-t-10">
							...
							<div class="price-container info-container m-t-20">
								<div class="row">
									...
									<div class="col-sm-6">
										<div class="price-box">
											<span class="price"> <?php echo currency_format($row['productPrice']);?></span>
											<span class="price-strike"><?php echo  currency_format($row['productPriceBeforeDiscount']);?></span>
										</div>
									</div>
									...
									<div class="col-sm-6">
										<div class="favorite-button m-t-10">
											<a class="btn btn-primary" data-toggle="tooltip" data-placement="right" title="Yêu Thích" href="product-details.php?pid=<?php echo htmlentities($row['id'])?>&&action=Yêu Thích">
...
?>
											...
											<div class="reviews" style="border: solid 1px #000; padding-left: 2% ">
												<div class="review">
													...
													<div class="text"><b>Gía :</b>  <?php echo htmlentities($rvw['price']);?> Sao</div>
													<div class="text"><b>Đánh giá :</b>  <?php echo htmlentities($rvw['value']);?> Sao</div>
												...
												<div class="table-responsive">
													<table class="table table-bordered">	
														...
														<tbody>
															...
															<tr>
																<td class="cell-label">Đánh Gía</td>
												...
												<div class="form-container">
														...
														<div class="row">
															<div class="col-sm-6">
																...
																<div class="form-group">
																	<label for="exampleInputSummary">Lựa chọn đánh giá <span class="astk">*</span></label>
																	<td>
																		<select value="Chọn" type="text" class="form-control txt" id="exampleInputSummary" placeholder="" name="summary" required="required" autofocus>
																		<option></option >
															...
															<div class="col-md-6">
																<div class="form-group">
																	<label for="exampleInputReview">Đánh giá khác </label>
...
while($rw=mysqli_fetch_array($qry))
{
	...
	<div class="product">		
		...
		<div class="product-info text-left">
			...
			<div class="product-price">	
				<span class="price">
					<?php echo currency_format($rw['productPrice']);?>			</span>
										     <span class="price-before-discount">
										     <?php echo currency_format($rw['productPriceBeforeDiscount']);?></span>
