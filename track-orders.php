...
<html lang="en">
	<head>
	    ...
	    <title>Theo Dõi Đơn Đặt Hàng</title>
			...
			<div class="row">
				<div class="col-md-12">
	              <h2>Theo Dõi Đơn Hàng Của Bạn</h2>
	                <span class="title-tag inner-top-vs">Vui lòng nhập ID đặt hàng của bạn vào hộp bên dưới và nhấn Enter. Điều này đã được trao cho bạn trên biên lai của bạn và trong email xác nhận bạn nên nhận được. </span>
