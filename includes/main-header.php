...
<div class="logo">
	...
	<h2 style="margin-top: 0px;  margin-left: 70px;"><em><strong><i> Truesmart</i></strong></em></h2>
...
<div class="search-area">
    <form name="search" method="post" action="search-result.php">
        <div class="control-group">
            ...
            <input style="width: 90%; padding: 10px;" class="search-field" placeholder="Tìm kiếm..." name="product" required="required" />

            <button style="padding: 9px 19px 10px;" class="search-button" type="submit" name="search"></button>    
	...
	?>
				...
				<div class="cart-item product-summary">
					<div class="row">
						...
						<div class="col-xs-7">
							...
							<div class="price"><?php echo currency_format($row['productPrice']+$row['shippingCharge']); ?>*<?php echo $_SESSION['cart'][$row['id']]['quantity']; ?></div>
						</div>
			...
			<div class="clearfix cart-total">
				<div class="pull-right">
						...
						<span class="text">Tổng cộng :</span><span class='price'><?php echo currency_format($_SESSION['tp']="$totalprice". ".00"); ?></span>
