...
$_SESSION['errmsg']="Mật khẩu đã thay đổi thành công";
exit();
}
else
{
...
$uri  = rtrim(dirname($_SERVER['PHP_SELF']),'/\\');
header("location:http://$host$uri/$extra");
$_SESSION['errmsg']="ID email không hợp lệ hoặc liên hệ không";
exit();
}
}
...
<html lang="vi">
	<head>
	    ...
	    <title>TRUESMART | Quên mật khẩu</title>
...
?>
		...
		<div class="form-group">
	  	...
	  	<div class="form-group">
		    <label class="info-title" for="exampleInputPassword1">Số Điện Thọai<span>*</span></label>
