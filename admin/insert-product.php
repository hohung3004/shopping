...
<div class="control-group">
<label class="control-label" for="basicinput">Nước sản xuất</label>
<div class="controls">
<input type="text"    name="productCompany"  placeholder="Nhập tên nước sản xuất" class="span8 tip" required>
</div>
</div>
<div class="control-group">
...
<div class="control-group">
<label class="control-label" for="basicinput">Giá sản phẩm sau khi giảm giá (giá bán)</label>
<div class="controls">
...
<div class="controls">
<textarea  name="productDescription"  placeholder="Mô tả Sản phẩm" rows="6" class="span8 tip">
</textarea>  
</div>
</div>
