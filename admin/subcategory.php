...
$sql=mysqli_query($con,"insert into subcategory(categoryid,subcategory) values(N'$category',N'$subcat')");
$_SESSION['msg']="Danh mục hãng được tạo ra !!";
...
<head>
	...
	<title>Quản trị viên | Danh Mục Hãng</title>
...
<div class="control-group">
<label class="control-label" for="basicinput">Tên danh mục hãng</label>
<div class="controls">
<input type="text" placeholder="Nhập tên danh mục hãng"  name="subcategory" class="span8 tip" required>
</div>
</div>
