...
if($query)
{
	echo "<script>alert('Bạn đang đăng ký thành công');</script>";
}
else{
echo "<script>alert('Không đăng ký có gì đó không ổn');</script>";
}
}
// Code for User login
...
$uri  = rtrim(dirname($_SERVER['PHP_SELF']),'/\\');
header("location:http://$host$uri/$extra");
$_SESSION['errmsg']="ID email hoặc mật khẩu không hợp lệ";
exit();
}
}
	...
	<div class="container">
		<div class="breadcrumb-inner">
			<ul class="list-inline list-unstyled">
				<li><a href="index.php">TrangChủ</a></li>
...
<div class="form-group">
	...
	<div class="checkbox">
		  ...
		  Tăng tốc độ của bạn thông qua thanh toán.
		</label>
		<label class="checkbox">
		Theo dõi đơn đặt hàng của bạn một cách dễ dàng.
		</label>
		<label class="checkbox">
		Giữ một hồ sơ của tất cả các giao dịch mua của bạn.
		</label>
	</div> -->
</div>	
