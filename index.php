...
<html lang="en">
	<head>
		...
		<!-- <link href=".font/Anuphan-VariableFont_wght.ttf" rel="stylesheet" type='text/css'> -->
		...
		<div class="row">
			<div class="col-md-6 col-sm-4 col-lg-4">
				<div class="info-box">
					<div class="row">
						...
						<div class="col-xs-10">
							<h4 class="info-box-heading green">Hòa Tiền</h4>
						</div>
					</div>	
					<h6 class="text">Đảm bảo trả lại tiền 30 ngày.</h6>
				</div>
			</div><!-- .col -->
			...
			<div class="hidden-md col-sm-4 col-lg-4">
				<div class="info-box">
					...
					<h6 class="text">Miễn phí vẫn chuyển cho đơn hàng trên 60.000đ</h6>	
				</div>
			</div><!-- .col -->
...
<!-- ============================================== INFO BOXES : END ============================================== -->		
		...
		<div id="product-tabs-slider" class="scroll-tabs inner-bottom-vs  wow fadeInUp">
			<div class="more-info-tab clearfix">
			   <h3 class="new-product-title pull-left" style=' font-weight: bold;'>Sản phẩm nổi bật</h3>
				<ul class="nav nav-tabs nav-tab-line pull-right" id="new-products-1">
					<li class="active"><a href="#all" data-toggle="tab">Tất Cả</a></li>
					<!-- <li><a href="#books" data-toggle="tab">Điện Thoại</a></li>
					<li><a href="#furniture" data-toggle="tab">Phụ Kiện</a></li> -->
				</ul><!-- /.nav-tabs -->
			</div>
	...
	<div class="product">		
		...
		<div class="product-info text-left">
			...
			<div class="product-price">	
				<span class="price">
					<?php echo currency_format($row['productPrice']);?>			</span>
...
?>
	...
	<div class="product">		
		...
		<div class="product-info text-left">
			...
			<div class="product-price">	
				<span class="price">
					 <?php currency_format($row['productPrice']);?>			</span>
										     <span class="price-before-discount"><?php currency_format($row['productPriceBeforeDiscount']);?></span>
...
<?php
$ret=mysqli_query($con,"select * from products where category=7 and subCategory=23");
while ($row=mysqli_fetch_array($ret)) 
{
?>
...
<?php }?>
	...
	<section class="section featured-product inner-xs wow fadeInUp">
		<h3 class="section-title">Smartwatch</h3>
								...
								<div class="row product-micro-row">
									...
									<div class="col col-xs-6">
										<div class="product-info">
											...
											<div class="product-price">	
												<span class="price">
													 <?php echo currency_format($row['productPrice']);?> 
													 <span class="price-before-discount"><?php echo currency_format($row['productPriceBeforeDiscount']);?> </span>
												</span>
