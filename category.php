...
<div class="side-menu animate-dropdown outer-bottom-xs">
    <div class="head"><i class="icon fa fa-align-justify fa-fw" style=' font-weight: bold;'></i>Danh mục</div>        
...
{
    ?>
                <a style=' font-weight: bold;' href="sub-category.php?scid=<?php echo $row['id'];?>" class="dropdown-toggle"><i class="icon fa fa-desktop fa-fw"></i>
...
<div class="sidebar-widget wow fadeInUp outer-bottom-xs ">
	<div class="widget-header m-t-20">
		<h4 class="widget-title" style=' font-weight: bold;'>LOẠI</h4>
	</div>
		...
		<div class="accordion">
	    	<div class="accordion-group">
	            <div class="accordion-heading">
	                <a href="category.php?cid=<?php echo $row['id'];?>"  style=' font-weight: bold;' class="accordion-toggle collapsed">
