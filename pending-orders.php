...
?>
				<tr>
					...
					<td class="cart-product-sub-total"><?php echo currency_format($price=$row['pprice']); ?>  </td>
					<td class="cart-product-sub-total"><?php  if( $shippcharge=$row['shippingcharge'] == 0){
	 ...
	 ?>   </td>
					<td class="cart-product-grand-total"><?php echo currency_format((($qty*$price)+$shippcharge));?></td>
					<td class="cart-product-sub-total"><?php echo $row['paym']; ?>  </td>
					<td class="cart-product-sub-total"><?php echo $row['odate']; ?>  </td>
					
					<td><a href="pending-orders.php?id=<?php echo $row['oid']; ?> ">Bỏ</td>
				</tr>
<?php $cnt=$cnt+1;} ?>
<tr>
	<td colspan="9"><div class="cart-checkout-btn pull-right">
							<button st type="submit" name="ordersubmit" class="btn btn-primary"><a style="color:white; " href="payment-method.php">Tiến hành thanh toán</a></button>
