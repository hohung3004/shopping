		...
		<table class="table table-bordered">
			<thead>
				...
				<th class="cart-romove item">#</th>
					...
					<th class="cart-total item">Thành Tiền</th>
...
?>
				<tr>
					...
					<td class="cart-image">
						...
						<img src="admin/productimages/<?php echo htmlentities($row['opid']);?>/<?php echo htmlentities($row['pimg1']);?>"  data-echo="admin/productimages/<?php echo htmlentities($row['opid']);?>/<?php echo htmlentities($row['pimg1']);?>" alt="" width="84" height="146">
					...
					<td class="cart-product-grand-total"><?php echo currency_format( $qty*$price);?></td></td>
...
<?php $cnt=$cnt+1;} } else { ?>
				<tr><td colspan="8">ID đặt hàng hoặc email đã đăng ký không hợp lệ</td></tr>
				<?php } ?>
			</tbody><!-- /tbody -->
		</table><!-- /table -->
